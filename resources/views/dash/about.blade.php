  ...
  <div class="row">
        ...
        <div class="tile">
          <div class="tile-body">
            ...
            @if($errors->any())
              ...
              @endif
            <form enctype="multipart/form-data" style="font-size: 16px" class="form-horizontal" action="{{ route("dash.abo.up") }}" method="post">
              @csrf
              <div class="form-group row">
                <label class="control-label col-md-3"><i class="fa fa-text"></i> Head</label>
                <div class="col-md-8">
                  <textarea rows="5" class="form-control" name="head">
                    {{ $about->head }}
                  </textarea>
                </div>
              </div>
                <div class="form-group row">
                  <label class="control-label col-md-3"><i class="fa fa-text"></i> Body</label>
                  <div class="col-md-8">
    ...
    <div class="col-md-4">
      <div class="tile">
        ...
        <div style="text-align: center"> <img style="border-radius: 0%;width: 40%" src="<?php $img = $info->photo; ?>{{ asset($img) }}" /></div>
        <br>
        <h6>
          <p style="word-wrap: break-word">{{ $about->head }}</p>
        </h6>
        <p style="word-wrap: break-word">{{ $about->body }}</p>
